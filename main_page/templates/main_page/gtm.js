...
"resource": {
  ...
  "rules":[
    [["if",0],["add",1,17,20,32,36,37,46,54,57,82,95,64,65]],
    [["if",0,1],["add",1]],
    [["if",4],["add",2,14,15,18,19,26,34,35,42,49,53,55,56,58,62,69,76,77,79,80,81,83,84,90,92,94]],
    [["if",5],["add",3]],
    [["if",6],["add",4,5,6,24,27,28,43,48,50,73]],
    [["if",0,7],["add",7,11,70]],
    [["if",0,8],["add",8]],
    [["if",0,9],["add",9]],
    [["if",0,10],["add",10]],
    ...
    [["if",10,12],["add",13]],
    [["if",0,13],["add",16]],
    [["if",14],["add",21,41,47,88]],
    [["if",15],["add",22,23,44,52,74,85]],
    [["if",0,16,17],["add",25]],
    [["if",4,18],["add",29]],
    [["if",4],["unless",18],["add",30]],
    [["if",0,19,20],["add",31,33,38,45,51,75]],
    [["if",0,21],["add",31,33,38,45,51,75]],
    [["if",0,22],["add",31,33,38,45,51,75]],
    [["if",0,23,24],["add",39]],
    [["if",0,25,26],["add",39]],
    [["if",14,27],["add",40,87]],
...
Z.h.ga=["google"],function(){var a,b;(function(c){Z.__ga=c;Z.__ga.i="ga";Z.__ga.m=!0;Z.__ga.priorityOverride=0})(function(c){function d(L){var J=[].slice.call(arguments,0);J[0]=u+J[0];t.push(J)}function e(L,J){void 0!==c[J]&&d(L,c[J])}function f(L,J){void 0!==c[J]&&d(L,Number(c[J]))}function g(L,J){if(n(J))for(var X=0;X<J.length;X++)d(L,J[X])}function h(L,J,X){if(n(J))for(var P=0;P<J.length;P++){for(var ea=[L],Ca=J[P],T=0;T<X.length;T++)ea.push(Ca[X[T]]);
d.apply(this,ea)}}function l(L,J){void 0!==c[J]&&d("_set",L,c[J])}function m(L,J){return void 0===J?J:L(J)}function p(L,J){void 0!==J&&(v+="&"+L+"="+J)}var n=Na,t=S("_gaq",[],!1),r=!1,u="";void 0==c.vtp_trackerName?u="gtm"+Lh()+".":""!==c.vtp_trackerName&&(u=c.vtp_trackerName+".");e("_setAccount","vtp_webPropertyId");d("_set","gtmid",bm(!0));
e("_setAllowLinker","vtp_allowLinker");
e("_setAllowAnchor","vtp_allowAnchor");e("_setAllowHash","vtp_allowHash");
g("_addIgnoredRef",c.vtp_ignoredRef);g("_addIgnoredOrganic",c.vtp_ignoredOrganic);var v="";if(""!==v){var w=function(L,J,X){for(var P=J.length-1;0<=P;P--){var ea=J[P].split("=");if(ea[0]===L)return ea[1]||"1"}for(var Ca=X.length-1;0<=Ca;Ca--){var T=X[Ca].split("=");if(T[0]===L)return T[1]||"1"}},y=ch(Tq()),x=ah(y,"query").split("&"),z=c.vtp_allowAnchor?ah(y,"fragment").split("&"):[];p("gclid",w("gclid",z,x));p("gclsrc",w("gclsrc",z,x));p("dclid",w("dclid",z,x));d("_set","campaignParams",
...
g("_cookiePathCopy",c.vtp_cookiePathCopy);var ca=function(){S("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,R(Sj("https","http","://stats.g.doubleclick.net/dc.js",r),ca,c.vtp_gtmOnFailure));else if(!a){var ra=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;R(Sj("https://ssl","http://www",ra,r),ca,c.vtp_gtmOnFailure)}})}();
